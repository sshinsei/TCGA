...
if(! dir.exists("07_multicox")){
  dir.create("07_multicox")
}
setwd("./07_multicox")
...
write.table(cbind(id = rownames(rt), cbind(rt1[ , 1:2], riskScore, risk)),
            file = "../00_rawdata/GSE14520/risk.txt", sep = "\t", quote = F, row.names = F)
cox
# GRHPR HAO1  
# genes2:EHHADH AGXT
# genes_clust:CYP7A1  UGT2B15 SPP1     
